...
import { theme, ThemeProvider } from '../../../../../kit/src/lib/components'; 
...
export const LoadingModal: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'A full-screen loading modal with a blurred backdrop. The `open` control can be used to show/hide it.',
      },
    },
  },
};
